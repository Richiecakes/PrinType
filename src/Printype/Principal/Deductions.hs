...
unify :: Deduction -> Deduction -> Substitution -> Deduction
unify (Ded d1 ctx1 t1 a1) (Ded d2 ctx2 t2 a2) u = 
  let ctx1' = apply u ctx1
      ctx2' = apply u ctx2
      ctx = Ctx.union ctx1' ctx2'
      ded1' = apply u (Ded d1 ctx1 t1 a1)
      ded2' = apply u (Ded d2 ctx2 t2 a2)
      a1' = apply u a1
  in Ded (Binary ded1' ded2') ctx (app t1 t2) (apply u (restype a1'))